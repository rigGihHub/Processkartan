...
def run():
    ...
    with sync_playwright() as p:
        ...
        text='Bolaget lanserade en ny tjänst på måndagen. Aktien steg senare under dagen. Företaget meddelade därefter att en större investering skulle påbörjas. Projektet startade på fredagen.'
        ...
        browser.close()
    print('browser v0.20.53 any source ok')
