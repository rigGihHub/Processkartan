...
const slices=e.pageSlicePlan(1000,3,90);
ok(slices.length===3&&slices[0].x===0&&slices[2].x===668,'page slice count/offset');
ok(slices.reduce((n,x)=>n+x.width,0)===1000,'page slices cover full width');
ok(slices.every(x=>x.headerPx===90),'page slices repeat header');
