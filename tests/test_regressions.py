...
def test_v0162_scale_process_is_top_level_and_stays_open():
    ...
    # v0.19.1 replaces +/- with a persistent slider that keeps the menu open.
    assert 'id="p48-process-scale"' in APP
...
def test_v0194_smart_decision_pair_is_wired():
    ...
    assert "{label}" in APP[APP.index('function addDecisionBranchNode'):APP.index("function addNextStepFromNode")]
